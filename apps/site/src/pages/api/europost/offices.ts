 ...
 *
 * Взят с запасом над всем справочником (сейчас в нём 339 отделений): при
 * обрезке по 200 полторы сотни отделений не доезжали до покупателя вовсе, и
 * найти своё он не мог ни в списке, ни на карте. Весь справочник весит около
 * 40 КБ — дешевле, чем объяснять, почему соседнего отделения нет. Потолок
 * оставлен на случай, если Европочта разрастётся втрое.
 */
const LIMIT = 1000;
