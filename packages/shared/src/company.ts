 ...
 *
 * Общие для сайта и CRM: адрес магазина попадает и на правовые страницы, и в
 * SMS покупателю о готовности заказа к выдаче. Две копии разъехались бы при
 * первом же переезде, и человек пришёл бы не туда.
 *
